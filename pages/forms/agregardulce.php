          ...
          <div class="box box-info">
            ...
            <form class="form-horizontal">
              <div class="box-body">
                ...
                <div class="form-group"  style="margin-left:10%;">
                  <label for="inputPassword3" class="col-sm-2 control-label">Existente</label>
              ...
              <div class="box-footer"> 
                <button type="submit" class="btn btn-info pull-right" style="margin-left:1%;">Agregar</button>
